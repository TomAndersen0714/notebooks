...
- [ ] 【知识沉淀】
	...
	- [ ] Hive
		...
		- [ ] HiveServer 集群管理命令
		- [ ] Hive SQL 客户端常用配置参数，[HiveSQL配置基础教程](work/component/Big-Data/Apache-Hive/Hive-SQL/HiveSQL配置基础教程.md)
...
每日待办事项暂时搁置，频次太高，不好维护，因此切换到“[每周待办清单](schedule/待办事项/每周待办清单.md)”，内容不变但是功能相同。
